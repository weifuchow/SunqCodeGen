...
package com.msxf.zwf.sysUser.service;

import com.msxf.zwf.sysUser.entity.BaseQuery;
import com.msxf.zwf.sysUser.entity.WeifuResult;
import com.msxf.zwf.sysUser.entity.PageResult;
...
public class BaseService<T extends JpaRepository & JpaSpecificationExecutor, Q extends BaseQuery> {
    ...
    public <S> WeifuResult getPage(Q query) {
        ...
        return WeifuResult.getIsOkResult(pageResult);
    }
